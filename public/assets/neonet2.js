...
function __wbg_adapter_32(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4f135873a176e550(arg0, arg1, addHeapObject(arg2));
}

/**
* @param {string} canvas_container_id
* @param {string} canvas_id
* @returns {Promise<WebFlow>}
*/
export function start_neonet(canvas_container_id, canvas_id) {
    const ptr0 = passStringToWasm0(canvas_container_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.start_neonet(ptr0, len0, ptr1, len1);
...
function __wbg_adapter_528(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h4a6dc8e133198014(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

const WebFlowFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webflow_free(ptr >>> 0));
/**
*/
export class WebFlow {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WebFlow.prototype);
        obj.__wbg_ptr = ptr;
        WebFlowFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WebFlowFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webflow_free(ptr);
    }
    /**
    * @param {number} width
    * @param {number} height
    ...
    */
    resize(width, height) {
        const ret = wasm.webflow_resize(this.__wbg_ptr, width, height);
        return takeObject(ret);
    }
    /**
    * @returns {Promise<any>}
    */
    render() {
        const ret = wasm.webflow_render(this.__wbg_ptr);
        return takeObject(ret);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_webflow_new = function(arg0) {
        const ret = WebFlow.__wrap(arg0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('neonet2_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
